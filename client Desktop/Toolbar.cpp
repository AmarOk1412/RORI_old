...
void Toolbar::setupUi()
{
    ...
    setStyleSheet("QPushButton { border:0; margin:0;} \
                   QPushButton::hover { background-color: #f19b1e; }");
    background->setStyleSheet("background-color: #252525;");
    setLayout(principalLayout);
}

/**
 * @brief Toolbar::setupConnect create connection between SIGNAL/SLOTS
 */
void Toolbar::setupConnect()
{
